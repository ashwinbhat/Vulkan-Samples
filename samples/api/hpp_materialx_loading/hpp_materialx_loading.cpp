...
/*
 * MaterialX loading using vulkan.hpp
 */

#include <hpp_materialx_loading.h>

HPPMaterialXLoading::HPPMaterialXLoading()
{
...
void HPPMaterialXLoading::request_gpu_features(vkb::core::HPPPhysicalDevice &gpu)
{
...
void HPPMaterialXLoading::build_command_buffers()
{
...
HPPMaterialXLoading::FrameBufferAttachment HPPMaterialXLoading::create_attachment(vk::Format format, vk::ImageUsageFlagBits usage)
{
...
void HPPMaterialXLoading::prepare_offscreen_buffer()
{
	{
...
void HPPMaterialXLoading::load_assets()
{
	// Models
...
void HPPMaterialXLoading::setup_descriptor_pool()
{
...
void HPPMaterialXLoading::setup_descriptor_set_layout()
{
...
void HPPMaterialXLoading::setup_descriptor_sets()
{
#if defined(ANDROID)
...
void HPPMaterialXLoading::prepare_uniform_buffers()
{
...
void HPPMaterialXLoading::update_uniform_buffers()
{
...
void HPPMaterialXLoading::update_params()
{
	uniform_buffers.params->convert_and_update(ubo_params);
}

void HPPMaterialXLoading::draw()
{
...
bool HPPMaterialXLoading::prepare(vkb::platform::HPPPlatform &platform)
{
...
void HPPMaterialXLoading::render(float delta_time)
{
	if (!prepared)
		return;
	draw();
...
void HPPMaterialXLoading::on_update_ui_overlay(vkb::HPPDrawer &drawer)
{
...
bool HPPMaterialXLoading::resize(const uint32_t width, const uint32_t height)
{
...
std::unique_ptr<vkb::Application> create_hpp_materialx_loading()
{
	return std::make_unique<HPPMaterialXLoading>();
}
